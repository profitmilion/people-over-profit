...
class FakeSmokeRuntime implements SmokeRuntime {
  ...
  async getTokenState(): Promise<SmokeTokenState> { return structuredClone(this.tokenState); }
  ...
  async getPool(): Promise<SmokePoolState> { return structuredClone(this.pool); }
  async getActivePositionId(): Promise<bigint> { return this.activePositionId; }
  async getPosition(): Promise<SmokePositionState> { return structuredClone(this.position); }

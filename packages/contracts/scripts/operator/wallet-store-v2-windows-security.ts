...
import {
  ...
  type WalletStoreV2ProductionFileSecurity,
...
export class WindowsWalletStoreV2ProductionFileSecurity implements WalletStoreV2ProductionFileSecurity {
  ...
  constructor(input: WindowsProductionPathPolicyInput) {
    ...
    if (!isInside(this.#rootDirectory, this.#localAppDataDirectory)) {
      throw new Error("Production Wallet Store v2 root must be below LOCALAPPDATA.");
    }
